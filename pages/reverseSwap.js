 ...
 setinput(e.target.value);
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link href="/" legacyBehavior>
      <a class="mr-5 hover:text-gray-900">Swap Token1-Token2</a>
    </Link>
    </nav>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Here you can swap Token2 to Token1</p>
    </div>
    ...
    <form onSubmit={swapToken1withToken2}>
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="name" class="leading-7 text-sm text-gray-600">Token2</label>
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="email" class="leading-7 text-sm text-gray-600">Token1</label>
